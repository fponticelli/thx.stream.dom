// Generated by Haxe 3.4.0 (git build development @ c9b7fac)
...
thx_stream_Subject.__name__ = true;
...
thx_stream_SubjectF.__name__ = true;
...
thx_stream_Subjects.__name__ = true;
...
thx_stream_dom_Dom.streamEvent = function(el,name,capture) {
	...
	return thx_stream_Stream.cancellable(function(o,addCancel) {
		var f = function(e) {
			o.message(thx_stream_Message.Next(e));
		};
		el.addEventListener(name,f,capture);
		addCancel(function() {
			el.removeEventListener(name,f,capture);
		});
	});
};
